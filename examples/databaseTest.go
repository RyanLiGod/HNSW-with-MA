...
//var efSearch3 = []int{10}

var NUM3, TESTNUM3, K3, DIMENSION3 int
var DIST3 string

func main() {
	preTypeList := []string{"siftsmall", "sift", "gist", "sift1_4", "sift1_8", "sift1_16", "glove25", "glove50", "glove100", "glove200"}
	//preTypeList := []string{"sift", "gist"}
	MList := []int{16, 32}
	efCList := []int{400, 800}
	...
	for _, preType := range preTypeList {
		for l := range MList {
			...
			xlsx, _ := excelize.OpenFile("../HNSW Experiments.xlsx")
